    ...
    <div class="search gutter">
      <el-form :inline="true"
        ...
        <el-form-item label="衣服种类">
          <el-select v-model="formInline.cost_type"
            class="w190"
            clearable>
    ...
    <div class="action">
      <div class="left">
        ...
        <el-button :disabled="!multipleSelection.length"
          @click="onHandleAction">删除</el-button>
      </div>
      <div class="right">
...
import { getCostTypeSelect, getCostList, getCostDetail, deleteCost, updateCost } from "@/network/api"
