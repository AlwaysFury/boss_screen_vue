<template>
	<div class="Aside" :class="{ fold: !expand }">
		<div class="top">
			<span class="title" v-show="expand">Shopee</span>
			<Fold class="btn-icon" v-if="expand" @click="onClickBtn" />
			<Expand class="btn-icon" v-else @click="onClickBtn" />
		</div>
		<div class="menu-box">
			<el-menu
			...
			>
				...
				<el-sub-menu index="2">
					...
					<el-menu-item index="/clothes">衣服种类列表</el-menu-item>
